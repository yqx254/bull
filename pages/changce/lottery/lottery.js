...
Page({
  ...
  onLoad: function (a) {
    ...
    e.setData({
      id: i
    }), t.get("changce/lottery/lottery_reward", {id:i}, function (t) {
      ...
      }), t.get("changce/lottery/lottery_info", {id:i}, function (t) {
      e.setData({
        bgul: t.data
      });
  ...
  getLottery: function () {
    ...
    var o = a.data.aas,
      l = o.length;
    i < 2 && (o.chance = !1), t.get("changce/lottery/getreward", { lottery:e}, function (i) {
      if (a.setData({
        ddd: i
        ...
        var n = i.id;
        t.get("changce/lottery/reward", { lottery: e, reward:n}, function (t) { });
    ...
    }), t.get("changce/lottery/lottery_info", {id:e}, function (t) {
      a.setData({
        bgul: t.data
      })
    })
  ...
  touchStart: function (e) {
    ...
    t.get("changce/lottery/getreward", { lottery:n}, function (t) {
      a.save(), a.beginPath(), a.clearRect(r, s, 50, 50), a.restore(), i.setData({
        guagua: t
      })
    }), t.get("changce/lottery/lottery_info", {id:n}, function (t) {
      i.setData({
        bgul: t.data
      })
    })
  ...
  touchEnd: function () {
    ...
    if ("number" != typeof e) wx.showModal({
      ...
      var i = this.data.id;
      t.get("changce/lottery/reward", { lottery: i, reward:e}, function (t) { });
  ...
  startGame: function () {
    if (!this.data.isRunning) {
      ...
      var a = this,
        e = a.data.id;
      t.get("changce/lottery/getreward", { lottery:e}, function (i) {
        var n = i.id;
        if ("number" != typeof n) wx.showModal({
          ...
          t.get("changce/lottery/reward&=", { lottery: e, reward:n}, function (t) { }), 0 == n && (n = 8);
